...
def test_demo_coordinator_creates_service_series_and_member_sees_event():
    ...
    with sync_playwright() as playwright:
        ...
        try:
            ...
            coordinator.get_by_role("link", name="Intervall erstellen").click()
            ...
            expect(coordinator.get_by_role("heading", name="Vorschau", exact=True)).to_be_visible()
            with coordinator.expect_navigation(wait_until="domcontentloaded"):
            ...
            expect(member.get_by_text("Planungsintervall", exact=False)).to_be_visible()
...
def test_admin_can_edit_demo_template_and_add_a_shift():
    ...
    with sync_playwright() as playwright:
        ...
        try:
            ...
            page.get_by_role("link", name="Dienst", exact=True).click()
